...
export let themes = enableSystem ? ['light', 'dark', 'system'] : ['light', 'dark'];
...
themeStore.set({
    ...
    systemTheme: (enableSystem ? getTheme(storageKey) : undefined)
});
...
const mediaHandler = (...args) => handleMediaQuery(...args);
